...
const generatePDF = () => {
  ...
  addSectionHeader('PART 4: UNDERSTANDING CHECKBOXES AND WORKFLOW');
  addSpace(5);

  addSubHeader('Purpose of "Final Goal" Checkbox');
  addText('After analyzing your goal, you will see a checkbox: "Have you reviewed all the details above and confirmed this as your final goal?"');
  addSpace(3);
  addText('Purpose:');
  addBullet('Confirms you have reviewed the AI analysis and recommendations');
  addBullet('Marks the goal as "finalized" in the system');
  addBullet('Indicates you are satisfied with the goal and ready to commit to it');
  addBullet('Allows the goal to be included in Gap Analysis');
  addSpace(3);
  addText('What Happens When You Check It:');
  addBullet('The goal is marked as "Final" in your goals list');
  addBullet('A confirmation message appears');
  addBullet('If you have not run Gap Analysis yet, you will be reminded to do so');
  addBullet('The goal becomes eligible for inclusion in Gap Analysis');
  addSpace(3);
  doc.setFont('helvetica', 'italic');
  addText('Important: You can still edit or delete the goal later if needed, but checking this box signals your commitment to this goal.');
  doc.setFont('helvetica', 'normal');
  addSpace(5);

  addSubHeader('Purpose of "All Goals Submitted" Checkbox');
  addText('After confirming a final goal, you will see: "Have you submitted all goals for the upcoming year?"');
  addSpace(3);
  addText('Purpose:');
  addBullet('Indicates you have completed entering ALL your goals for the year');
  addBullet('Triggers automatic redirection to Gap Analysis');
  addBullet('Ensures you do not forget to run Gap Analysis');
  addBullet('Marks a milestone in your goal-setting process');
  addSpace(3);
  addText('What Happens When You Check It:');
  addBullet('A confirmation dialog appears asking if you are sure');
  addBullet('Upon confirmation, you are automatically redirected to the Gap Analysis page');
  addBullet('You can still return to create more goals if needed');
  addBullet('The system tracks that you have indicated completion');
  addSpace(3);
  doc.setFont('helvetica', 'italic');
  addText('Note: This is a convenience feature. You can always navigate to Gap Analysis manually, and you can create additional goals even after checking this box.');
  doc.setFont('helvetica', 'normal');
  addSpace(5);

  addSubHeader('Checkbox Workflow Summary');
  addText('Step 1: Create and analyze a goal');
  addText('Step 2: Review AI feedback and recommendations', 5);
  addText('Step 3: Refine goal if needed and re-analyze', 5);
  addText('Step 4: Check "Final Goal" checkbox when satisfied', 5);
  addText('Step 5: Repeat Steps 1-4 for all your goals', 5);
  addText('Step 6: Check "All Goals Submitted" checkbox when done', 5);
  addText('Step 7: Automatically redirected to Gap Analysis', 5);
  addText('Step 8: Review coverage and create additional goals if needed', 5);
  addSpace(5);

  addSubHeader('Why Gap Analysis is Mandatory');
  addText('Gap Analysis is a critical step in the goal-setting process for several reasons:');
  addSpace(3);
  addText('1. Comprehensive Coverage:');
  addBullet('Ensures your goals cover all organizational Thrust Areas (TAs)');
  addBullet('Verifies alignment with all Group Objectives (GOs)');
  addBullet('Identifies blind spots in your goal portfolio');
  addSpace(3);
  addText('2. Strategic Alignment:');
  addBullet('Confirms your goals support organizational priorities');
  addBullet('Highlights areas where additional goals may be needed');
  addBullet('Ensures balanced coverage across strategic focus areas');
  addSpace(3);
  addText('3. Risk Mitigation:');
  addBullet('Identifies critical gaps that could impact performance reviews');
  addBullet('Prevents over-concentration in one area at the expense of others');
  addBullet('Provides early warning of coverage issues');
  addSpace(3);
  addText('4. Organizational Requirement:');
  addBullet('Management requires comprehensive goal coverage');
  addBullet('Gap Analysis provides documented evidence of coverage');
  addBullet('Supports performance evaluation and planning processes');
  addSpace(3);
  doc.setFont('helvetica', 'bold');
  addText('Best Practice: Aim for at least 75% coverage in both Thrust Areas and Group Objectives.');
  doc.setFont('helvetica', 'normal');
  addSpace(10);

  addSectionHeader('PART 5: UNDERSTANDING KEY FEATURES');
  addSpace(5);
